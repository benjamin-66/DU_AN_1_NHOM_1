...
class CommentValidation
{
    public static function edit(): bool
    {
        ...
        if (!isset($_POST['status']) || $_POST['status'] === '') {
            NotificationHelper::error('status', 'Vui lòng không để trống nội dung bình luận');
            $is_valid = false;
        }
    ...
    public static function createClient(): bool
    {
        ...
        if (!isset($_POST['user_id']) || $_POST['user_id'] === '') {
            NotificationHelper::error('user_id', 'Vui lòng không để trống mã người dùng bình luận');
            $is_valid = false;
        }
