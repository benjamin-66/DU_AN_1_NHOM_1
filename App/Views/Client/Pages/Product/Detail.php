            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    ?>
                        ...
                        <h6><?= $data['product']['category_name'] ?></h6>
                        ...
                        <div class="comment-widgets">
                            ...
                            <div class="d-flex flex-row comment-row m-t-0">
                                <div class="p-2">
                                    ...
                                    if ($item['avatar']) :
                                    ?>
                                        <img src="<?= APP_URL ?>/public/uploads/users/" alt="user" width="50" class="rounded-circle">
                                    <?php
                                    else :
                                        ?>
                            ...
                            <div class="d-flex flex-row comment-row">
                                ...
                                <div class="comment-text w-100">
                                    ...
                                    <form action="/comments" method="post">
                                        ...
                                        <input type="hidden" name="product_id" id="product_id" value="<?=$data['product']['id']?>" id="">
