...
{
    public static function cookView($id, $view)
    {
        ...
        //kiểm tra product_id có tồn tại trong cookie view hay chx
        ...
        //chuyển arrayy thành string để lưu vào cookie view
